...
ENTRIES = [
    ...
    entry(
        ...
        sources=[
            src("https://github.com/kylemclaren/jevql", "repo", "README SQL API, install and usage; API client in internal/typesafe/client.go", "kylemclaren", "2026-09-18"),
        ],
        repo_url="https://github.com/kylemclaren/jevql",
        demo_url="https://jevql.fly.dev",
        install_url="https://github.com/kylemclaren/jevql#install",
...
CREDITS = {
    ...
    "jevql": by("kylemclaren", "Kyle McLaren"),
